...
def trigger_manual_sync():
    ...
    try:
        ...
        if sync_type == 'full':
        ...
        elif sync_type == 'seed_matchups':
            result = SyncService.seed_matchups()
            ...
            return jsonify({
                'success': False,
                'error': 'Invalid sync type. Use: full, teams, league_state, matchups, seed_matchups, players, or transactions'
            }), 400
